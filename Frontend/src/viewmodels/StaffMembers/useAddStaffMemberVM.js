...
export const useAddStaffMemberVM = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            // Pobranie wiadomości z backendu
            const backendMessage =
                err?.response?.data?.message ||           // np. pojedynczy komunikat
                (err?.response?.data?.errors &&          // np. tablica błędów walidacyjnych
            ...
            // Błąd krytyczny, jeśli brak odpowiedzi backendu (np. brak sieci)
