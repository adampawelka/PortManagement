...
import "../styles/Thumb_Raiser.css"; // we'll move your CSS here

const ThumbRaiserUI: React.FC = () => {
  return (
    <div id="parent">
      <div id="views-panel">
      ...
      <div id="help-panel">
        <table className="help">
          <tbody>
            <tr>
              <th colSpan={2} style={{ fontSize: "3.0vmin" }}>Help</th>
            </tr>
            <tr>
              <th colSpan={2} style={{ textAlign: "left" }}>Select active view</th>
            </tr>
            <tr><td></td><td>Fixed view</td></tr>
            <tr><td></td><td>First-person view</td></tr>
            <tr><td></td><td>Third-person view</td></tr>
            <tr><td></td><td>Top view</td></tr>
            <tr>
              <th colSpan={2} style={{ textAlign: "left" }}>Toggle view mode</th>
            </tr>
            <tr><td></td><td>Single-view mode / multiple-views mode</td></tr>
            <tr>
              <th colSpan={2} style={{ textAlign: "left" }}>Display / hide subwindows</th>
            </tr>
            <tr><td></td><td>User interface</td></tr>
            <tr><td></td><td>Mini-map</td></tr>
            <tr><td></td><td>Help</td></tr>
            <tr><td></td><td>Statistics</td></tr>
            <tr>
              <th colSpan={2} style={{ textAlign: "left" }}>Move character</th>
            </tr>
            <tr><td></td><td>Walk / run (modifier key)</td></tr>
            <tr><td></td><td>Turn left slowly / quickly</td></tr>
            <tr><td></td><td>Turn right slowly / quickly</td></tr>
            <tr><td></td><td>Walk / run backward</td></tr>
            <tr><td></td><td>Walk / run forward</td></tr>
            <tr>
            ...
            <tr><td></td><td>Punch</td></tr>
            <tr><td></td><td>Thumbs up</td></tr>
          </tbody>
        </table>
      </div>
