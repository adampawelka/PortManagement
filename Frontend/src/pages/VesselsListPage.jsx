...
import { Container, Typography, CircularProgress, Alert, Paper, TableContainer, Table, TableHead, TableRow, TableCell, TableBody } from '@mui/material';
...
const VesselsListPage = () => {
  ...
  return (
    <Container maxWidth="xl" sx={{ mt: 4, backgroundColor: '#ffffff', p: 4, borderRadius: 2, boxShadow: 3 }}>
      ...
      {!loading && vessels.length === 0 && !error && <Alert severity="info">No vessels found.</Alert>}
